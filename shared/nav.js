...
(function(){
  ...
  '      <div class="tn-dd">'+
  '        <a href="'+P+'estatuto-tributario.html">§ Estatuto Tributario</a>'+
...
/* AUTO-CATALOGO:END */
  ...
  var SITE_INDEX={
    ...
    'flujo-caja.html':{title:'Flujo de Caja',cat:'Auxiliares',tags:'flujo de caja pyme presupuesto de efectivo semanal quincenal mensual rolling forecast 13 semanas cedula de cobros nomina prima cesantias vencimientos DIAN por NIT retefuente IVA renta ICA proyeccion tesoreria'},
    'presupuesto-empresarial.html':{title:'Presupuesto Empresarial',cat:'Auxiliares',tags:'presupuesto empresarial pyme presupuesto maestro estado de resultados presupuestado presupuesto de ventas costo de venta gastos fijos variables control presupuestal plan vs real variacion favorable desfavorable'},
    ...
    'estatuto-tributario.html':{title:'Estatuto Tributario',cat:'Auxiliares',tags:'estatuto tributario ET articulado artículos renta IVA retención fuente procedimiento sanciones UVT régimen simple GMF decreto 624 206 383 240'},
    ...
    'liquidador-prima.html':{title:'Prima de servicios',cat:'Auxiliares',tags:'calculadora prima de servicios Art 306 CST Ley 1788 2016 prima junio diciembre semestre proporcional base salario auxilio transporte salario variable cuándo se paga la prima'},
